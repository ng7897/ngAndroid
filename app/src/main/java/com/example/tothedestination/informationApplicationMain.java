...
public class informationApplicationMain extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if(id==R.id.About_programmer)
        {
            ...
            Intent intent1 = new Intent(informationApplicationMain.this, informationProgrammerMain.class);
            startActivity(intent1);
        }
        else if(id==R.id.about_app)
        {
            Toast.makeText(this,"you selected About app", Toast.LENGTH_SHORT).show();
            Intent intent1 = new Intent(informationApplicationMain.this, informationApplicationMain.class);
            startActivity(intent1);
        }
        else if (id == R.id.action_signout)
        {
            ...
            Intent intent1 = new Intent(informationApplicationMain.this, finalstartMain.class);
            startActivity(intent1);
        }
        ...
        else if(id==R.id.action_attractionListChange)
        {
            ...
            Intent intent = new Intent(informationApplicationMain.this, MasterattractionMain.class);
            startActivity(intent);
        }
        else if(id==R.id.action_flyListChange)
        {
            Toast.makeText(this,"you selected change fly list", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(informationApplicationMain.this, MasterFlyMain.class);
            startActivity(intent);
        }
        return true;
    }
